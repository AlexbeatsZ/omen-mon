    ...
    public abstract class LocaleData {
        ...
        protected Dictionary<string, string> msgFallback 
            = new Dictionary<string, string>() {
                ...
                ["GuiMainTabLighting"] = "Lighting",
                ["GuiMainTabPerformance"] = "Performance",
                ...
                ["GuiTipFanProgEdit"] = "Edit the selected fan curve",
                ...
                ["Prog"] = "Program",
                ["ProgAlt"] = "[Alt]",
                ["ProgDescCoolBoost"] = "strong cooling, earlier fan ramp",
                ["ProgDescOmenBalanced"] = "Omen-like balanced profile",
                ["ProgDescOmenEco"] = "Omen-like quiet and lower-power profile",
                ["ProgDescOmenPerformance"] = "Omen-like performance profile",
                ["ProgDescPower"] = "performance mode with automatic curve",
                ["ProgDescSilent"] = "quieter battery-friendly curve",
